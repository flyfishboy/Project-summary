...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        $("#lineChart").length) {
            ...
            var c1=document.getElementById("chart1").value;
            var c2=document.getElementById("chart2").value;
            var c3=document.getElementById("chart3").value;
            var c4=document.getElementById("chart4").value;
            
            var c5=document.getElementById("chart5").value;
            var c6=document.getElementById("chart6").value;
            var c7=document.getElementById("chart7").value;
            var c8=document.getElementById("chart8").value;
            
            new Chart(f, {
                type: "line",
                data: {
                    labels: ["第一题", "第二题", "第三题", "第四题"],
                    datasets: [{
