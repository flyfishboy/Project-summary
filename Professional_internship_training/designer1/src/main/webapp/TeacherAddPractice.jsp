            ...
            <div class="opshow" style="background-color: white">
                <div class="opshow1">
                    <form action="t_addPracticeServlet" method="post">
                       <p>学号：</p><input type="text" name="s_id" value="">
                        <p>姓名：</p><input type="text" name="s_name" value="">
                        <p>性别:</p><select name="s_sex" > <option value="男">男</option> <option value="女">女</option></select>
                        <p>    </p>
                       <p>开始时间：</p> <input type="date" name="p_bdate" value="">
                        <p>结束时间</p><input type="date" name="p_edate" value="">
                        <p>状态</p><select name="p_type" > <option value="正在实习">正在实习</option> <option value="还未实习">还未实习</option></select>
                        <p>    </p>
                        <p>实习单位</p><input type="text" name="p_unit" value="">
                        <p>单位电话</p><input type="text" name="p_uphone" value="">
