...
<div style="overflow: hidden">
    ...
    <div style="float: left;width: 30%">
        ...
        <br><br><br>
        <form method="post" action="/s_up_spsdServlet">

            <input type="hidden" name="opsd0" value=<%=psd %>>

            <div class="inputDiv">
                <p class="icon">
                    <img src="image/2.png"  style="height: 47px;width:47px">
                </p>
                <input type="password" placeholder="验证旧密码" name="opassword" class="txt">
            </div>
            ...
            <div class="inputDiv">
                ...
                <input  type="password" placeholder="设置新密码" name="npassword" class="txt">
            </div>
