...
<div class="all" >
    ...
    <div class="contmain">
        ...
        <div class="matter">
            ...
            <form method="post" action="a_update_Servlet">
        姓名: <td><input type="text" name="na_name" value=""> <br>
        性别: <select name="na_sex">
                    <option>男</option>
                    <option>女</option>
                </select><br>
    <input type="text" name="a_id" value="<%=id %>" style="display:none">
                <input type="submit" value="确认修改" style="margin-top:20px;font-size:20px;border: 0px;">
            </form>
            </div>
        </div>
    </div>
