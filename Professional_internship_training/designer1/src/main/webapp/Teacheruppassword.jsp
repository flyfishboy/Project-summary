            ...
            <div style="margin-top: 20px">
                ...
                <u1 >
                    ...
                    <c:if test="${not empty id}">
                        <li>/<a href="Teacheruppassword.jsp" style="decoration: none">修改密码</a></li>
                    </c:if>
                </u1>
            </div>
        </div>
    ...
    <div class="contmain">
        ...
        <div class="matter">
            <div class="operation" style="text-align: center">
                ...
                <ul>
                    <li><a href="Teacherupmsg.jsp">修改信息</a></li>
                    <li><a href="Teacheruppassword.jsp">修改密码</a></li>
                    <li><a href="login.jsp">注销登录</a></li>
                </ul>
            </div>
            <div class="opshow" style="background-color: white">

                <form action="t_change_passServlet" method="post">
                    <%
                        if (request.getAttribute("fmsg")==null){

                        }else{ %>
                    <p style="color: red"><%=request.getAttribute("fmsg")%></p>
                    <%
                        }
                    %>
                    <input type="text" value="<%=id%>" name="id" style="display: none">
                    <input type="text" value="<%=password%>" name="oldpassword" style="display: none">
                    原密码：<input type="text" value="" name="password" style="margin-top: 30px;line-height: 30px;border: #aed5e1 solid 2px;width: 200px"><br>
                    新密码：<input type="text" value="" name="npassword"  style="margin-top: 30px;line-height: 30px;border: #aed5e1 solid 2px;width: 200px"><br>
                    <input type="submit" value="确认修改" style="position: relative;left: 30%;">
                </form>
            </div>
