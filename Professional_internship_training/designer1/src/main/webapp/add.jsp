    ...
    <form method="post" action="/add" enctype="Multipart/form-data">
        <div >
            ...
            <div align="center" style="color: #ffffff;font-size: 30px">
                <h1>添加招聘信息</h1>
                <span style="font-size: 13px">只需4步即可添加招聘信息哦~</span>
            </div>
                <br><br>
      ...
      <div align="center" style="font-size: 15px">
          ...
          工作名称: <input style="border-radius:8px;background-color:#d5e5e9;width: 250px;height: 35px"  type="text" name="jobname"  placeholder="( 例: 厨师 )"><br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          联系电话: <input style="border-radius:8px;background-color:#d5e5e9;width: 250px;height: 35px" type="text" name="pnumber" placeholder="( 例: 138****3339 )"><br><br><br>

          <li style="font-size: 40px;font-family: 'Microsoft YaHei UI';border-radius: 8px;background-color: #ed8ec9;padding: 0px 20px">
              3
          </li>
          工作介绍:<input style="border-radius:8px;background-color:#d5e5e9;width: 250px;height: 35px" type="text" name="introduction" placeholder="( 例: 要求福利待遇等 )"><br><br><br>

          <li style="font-size: 40px;font-family: 'Microsoft YaHei UI';border-radius: 8px;background-color: #c685ed;padding: 0px 20px">
              4
          </li>
          大概薪水: <input style="border-radius:8px;background-color:#d5e5e9;width: 250px;height: 35px" type="text" name="salary" placeholder="( 例: 100万 )"><br><br><br><br>

          <input style="border-radius:8px;background-color:#a0cbde;color:white;width: 100px;height: 50px" type="submit" value="确定添加">
