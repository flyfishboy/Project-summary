...
<form action="t_change_msgServlet" method="post">
    <input type="text" value="<%=id%>" name="id" style="display: none">
    <p  style="margin-top: 30px;">姓名：${name}</p><br>
    <p >性别：${sex}</p><br>
    出生年月：<input type="date" value="<%=birthday%>" name="bir"><br>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp专业：<input type="text" value="<%=profession%>" name="profess"><br>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp电话：<input type="text" value="<%=phone%>" name="tel"><br>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspQQ:<input type="text" value="<%=qq%>" name="qq"><br>
   <input type="submit" value="确认修改" style="position: relative;left: 20%;">
</form>
            </div>
