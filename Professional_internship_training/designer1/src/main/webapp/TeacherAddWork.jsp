    ...
    <div class="contmain">
        ...
        <div class="matter">
            <div class="opshow" style="background-color: white">
                <div class="opshow1">
                    <form action="t_AddWorkServlet" method="post">
                        <input type="text" value="0" name="s_id" style="display: none">
                        <p>标题：</p><input type="text" name="m_title">
                        <p>截止时间：</p> <input type="date" name="m_date" value="">
                        <p>任务内容：</p><input type="text" name="m_content" value="null" >
                        <input type="text" name="m_grade" value="0" style="display: none">
                        <input type="text" name="t_id" value="<%=id%>" style="display: none">
