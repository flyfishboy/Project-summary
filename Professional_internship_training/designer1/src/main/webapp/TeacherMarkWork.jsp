...
<%
    ...
    String m_grade=(String)request.getParameter("m_grade");
    ...
    <div class="contmain">
        ...
        <div class="matter">
            <div class="opshow" style="background-color: white">
                <div class="opshow1">
                    <form action="t_UpdateWorkServlet" method="post">
                        <input type="text" name="m_id" value="<%=m_id%>" style="display: none">
                        <p style="width: 30%">编号：</p><p style="width: 50%;text-align: left"><%=m_id%></p>
                        <p style="width: 30%">学号：</p><p style="width: 50%;text-align: left"><%=s_id%></p>
                        <p style="width: 30%">提交时间:</p><p style="width: 50%;text-align: left"><%=m_date%></p>
                        <p>成绩：</p> <input type="text" name="m_grade" value="">
                        <p>汇报：</p><textarea  cols="30" rows="10" name="m_content" ><%=m_content%></textarea>
                        <input type="submit" value="提交" style="position: relative;left: 40%;margin-top: 220px">
                    </form>
