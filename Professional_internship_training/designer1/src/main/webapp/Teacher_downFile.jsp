...
<%@ page import="cn.keshe.entity.file" %>
        ...
        <div class="matter">
            <div class="opshow" style="background-color: white" align="center">
                ...
                <div style="background-color: lavender;width: 100%">
                    <p style="position: relative;float: left;width: 45%;line-height: 30px;background-color: lavender;border-right: #333333 solid 1px;text-align: center">文件名称</p>
                    ...
                    <p style="position: relative;float: left;width: 12%;line-height: 30px;background-color: lavender;border-right: #333333 solid 1px;text-align: center">学生学号</p>
                    <p style="position: relative;float: left;width: 20%;line-height: 30px;background-color: lavender;border-right: #333333 solid 1px;text-align: center">下载</p>
                </div>
                <%
                ...
                <div style="margin-top: 30px;text-align: center;margin-bottom: 30px">
                    <br>
                    <p style="position: relative;float: left;width: 45%" id="fna"><%=message.getFilename()%></p>
                    <p style="position: relative;float: left;width: 20%"><%=message.getWorkname() %></p>
                    <p style="position: relative;float: left;width: 12%"><%=message.getS_id()%></p>
                    <div style="position: relative;width: 20%;float: left">
                        <a style="position: relative;width: 100%;float: right" href="t_down_1fileServlet?name=<%=message.getFilename()%>">下载附件</a>
                    </div>
                    <%	}
                    } %>
                </div>
