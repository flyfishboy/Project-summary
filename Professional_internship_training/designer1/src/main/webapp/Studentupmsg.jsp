...
<div class="all" >
            ...
            <div style="margin-top: 20px">
                ...
                <u1 >
                    ...
                    <c:if test="${not empty id}">
                        <li>/<a href="StudentupPas.jsp" style="decoration: none">修改密码</a></li>
                    </c:if>
                </u1>
            </div>
        </div>
    ...
    <div class="contmain">
        ...
        <div class="matter">
            ...
            <div class="opshow">
                <div class="opshow1-1">
                    <form action="s_change_msgServlet">
                    <p >学号：${id}</p><br>
                    <p >姓名：${name}</p><br>
                    <p >性别：<%=sex%></p><br><input type="hidden" name="id" value="<%=id%>">
                    <p >出生年月：<input type="date" name="bir" value="<%=birthday%>"></p><br>
                    <p >班级：<%=clas%></p><br>
                    <p >专业：<%=profession%></p><br>
                    <p >电话：<input type="text" name="tel" value="<%=phone%>"></p><br>
                    <p >QQ：<input type="text" name="qq" value="<%=qq%>"></p><br>
                    <p >指导老师：<%=tname%></p><br>
                        <input style="position: relative;left: 50%" type="submit" value="修改">
                    </form>
                </div>
