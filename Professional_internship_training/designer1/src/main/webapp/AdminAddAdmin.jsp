    ...
    <div class="contmain">
        ...
        <div class="matter">
            ...
            <div class="opshow" align="center">
                <form action="a_add_Servlet" method="post" style="margin-top: 40px">
                    <p >工号：<input type="text" name="a_id" value="" ></p><br>
                    <p >姓名：<input type="text" name="a_name" value=""></p><br>
                    <p >密码：<input type="text" name="a_password" value=""></p><br>
                    <p >性别：<select name="a_sex"   >
                        <option>男</option>
                        <option>女</option>
                    </select></p><br>
