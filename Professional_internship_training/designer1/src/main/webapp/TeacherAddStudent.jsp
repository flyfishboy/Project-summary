    ...
    <div class="contmain">
        ...
        <div class="matter">
            <div class="opshow" style="background-color: white">
                <div class="opshow1">
                    <form action="t_s_AddServlet" method="post">
                        <p>学号：</p><input type="text" value="" name="s_id">
                        <p>姓名：</p><input type="text" value="" name="s_name">
                        <p>性别:</p><select name="s_sex" > <option value="男">男</option> <option value="女">女</option></select>
                        <p>班级：</p><input type="text" value="" name="s_class">
                        <p>专业</p><input type="text" value="" name="s_profession">
                        <p>密码：</p><input type="text" value="" name="s_password">
                        <p>出生年月：</p><input type="date" value="" name="s_birthday">
                        <p>电话：</p><input type="text" value="" name="s_phone">
                        <p>QQ：</p><input type="text" value="" name="s_qq">
                        <input type="text" value="<%=id%>" style="display: none" name="t_id">
                        <input type="text" value="<%=name%>" style="display: none" name="t_name">
                    ...
                    <%
                        ...
                        if(Smsg!=null){
                    %>
                   <p style="position: relative;left: 30%;color: red"><%=Smsg%></p>
                    <%
                        }
                    %>
                </div>
