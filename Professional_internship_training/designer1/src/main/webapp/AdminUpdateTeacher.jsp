...
<%
    ...
    String nsex= (String) request.getSession().getAttribute("sex");
    ...
    <div class="contmain">
        ...
        <div class="matter">
            ...
            <div class="opshow" align="center">
                    <form action="a_t_update_Servlet" method="post" style="margin-top: 40px">
                        <p >工号：<input type="text" name="nid" value="<%=tid%>"></p><br>
                        <p >姓名：<input type="text" name="nname" value="<%=tname%>"></p><br>
                        <p >密码：<input type="text" name="npasd" value="<%=psd%>"></p><br>
                      <p >性别：<select name="nsex" >
                        <option>男</option>
                        <option>女</option>
                    </select></p><br>
                        <p >出生日期：<input type="date" name="nbird" value="<%=birth%>"></p><br>
                        <p >专业：<input type="text" name="nprof" value="<%=profess%>"></p><br>
                        <p >电话：<input type="text" name="npho" value="<%=telphone%>"></p><br>
                        <p >QQ：<input type="text" name="nqq" value="<%=qq%>"></p><br>
                         <input type="text"   name="t_id" value="<%=tid %>" style="display:none"><br>
